      ...
      {showFeedback ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          <div>
            ...
            <textarea
              ...
              placeholder="e.g. The subject line is too aggressive. Make it more curious and less salesy. Also the opening line should reference their specific product category..."
              rows={4}
              style={{
        ...
        <div>
          ...
          <div style={{ fontSize: '12px', color: 'var(--muted)', marginBottom: '16px' }}>
            Approving will apply the same style and tone to all leads and start sending. This cannot be undone.
          </div>
          <div style={{ display: 'flex', gap: '10px' }}>
            <button onClick={() => setShowFeedback(true)} style={btnGhost}>
              Request changes
            </button>
